...
#define NUM_SAMPLES_PER_STRATIFY_CELL 3
                    ...
                    for (int stratifyIndexY = 0; stratifyIndexY < optixLaunchParams.stratifyResY; stratifyIndexY++)
                    {
                        ...
                        for (int sample = 0; sample < NUM_SAMPLES_PER_STRATIFY_CELL; sample++)
                        {
                            ...
                            { 
                                ...
                                //int vIndex = optixLaunchParams.cubeMapResolution * faceV;
                                //int uvOffset = vIndex * optixLaunchParams.cubeMapResolution + uIndex;
                                //int probeOffset = (nonEmptyCellIndex * 8 * 6 + minDistanceIndex * 6) * (optixLaunchParams.cubeMapResolution * optixLaunchParams.cubeMapResolution);
